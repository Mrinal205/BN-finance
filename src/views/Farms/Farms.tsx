  ...
  return (
    <>
      <div className="backbg">
        <Heading as="h1" scale="xxl" className="head-light head_title" color="secondary" mb="24px">
          {t('Farms')}
        </Heading>
      ...
      <Page >
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/decorations/3dpan.png" alt="Pancake illustration" width={460} height={103} style={{marginTop: '200px'}}/>
      </Page>
</div>
    </>
  )

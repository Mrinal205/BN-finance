  ...
  return (
    <StyledStepCard width="100%">
      <StepCardInner height={['200px', '180px', null, '200px']}>
        <Text mb="16px" fontSize="12px" bold textAlign="right" className="twentyFour" textTransform="uppercase">
          {step.label}
        </Text>
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in FARM per ticket.'),
    },
    {
  ...
  return (
    <Box width="100%">
      <Flex mb="40px" alignItems="center" flexDirection="column">
        ...
        <Text textAlign="center" className="twentyFour">
          {t(
            'If the digits on your tickets match the winning numbers in the correct order, you win a portion of the prize pool.',
          )}
        </Text>
        <Text className="twentyFour">{t('Simple!')}</Text>
      </Flex>
      <StepContainer className="eighteenFour">
        {steps.map((step) => (
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text mb="16px" color="textSubtle" className="twentyFour">
            {t('Here’s an example lottery draw, with two tickets, A and B.')}
          </Text>
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle" className="twentyFour">
                {t(
          ...
          <Text mt="16px" color="textSubtle" className="twentyFour">
            {t(
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text color="textSubtle" className="twentyFour">{t('The prizes for each lottery round come from three sources:')}</Text>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle" className="twentyFour">
                {t('100% of the FARM paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle" className="twentyFour">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed FARM for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  '10,000 FARM from the treasury is added to a lottery round every other day. This FARM is of course also included in rollovers! Read more in our guide to ',
                )}

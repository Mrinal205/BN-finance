...
const YourHistoryCard = () => {
  ...
  const getHeader = () => {
    ...
    return <Heading scale="md" style={{color: "#000"}}>{t('Rounds')}</Heading>
  }
  ...
  const getBody = () => {
    ...
    if (!account) {
      return (
        <StyledCardBody>
          <Text textAlign="center" color="textSubtle" mb="16px" className="twentyFour">
    ...
    return (
      <CardFooter>
        <Flex flexDirection="column" justifyContent="center" alignItems="center">
          <Text fontSize="12px" color="textSubtle" className="twentyFour">
